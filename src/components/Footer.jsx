      ...
      <div className={`container ${styles.footerGrid}`}>
        ...
        <div className={styles.col}>
          ...
          <ul className={styles.colLinks}>
            ...
            <li>
              <button className={styles.linkBtn} onClick={() => scrollTo('novidades')}>
                Novidades
              </button>
            </li>
            <li>
              <button className={styles.linkBtn} onClick={() => scrollTo('promocoes')}>
                Promoções
              </button>
            </li>
          </ul>
        ...
        <div className={styles.col}>
          ...
          <div className={styles.socials}>
            ...
            {/* Instagram */}
            <a
              href="https://instagram.com/koreaimports__2"
              target="_blank"
            ...
            {/* WhatsApp */}
            <a
              href="https://wa.me/5511978050852?text=Olá! Vim pelo site da Korea Imports. Gostaria de saber mais informações."
              target="_blank"
              rel="noopener noreferrer"
              aria-label="WhatsApp"
              className={`${styles.social} ${styles.socialWhatsapp}`}
            >
